...
module Support
  ...
  module MockRails
    module TestHelper
      include Support::ConstStub

      def before_setup
        # Stub it out and make sure it's reset before each test
        silence_warnings { Object.const_set(:Rails, Support::MockRails) }
        Support::MockRails.reset
      ...
      def after_teardown
        # Remove the "stub"
        silence_warnings { Object.__send__(:remove_const, :Rails) if defined?(Rails) }
